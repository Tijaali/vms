            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-sample" action="{{ route('empoylee.update', [$securityOfficer->id]) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" placeholder="Name" class="form-control"
                                                value="{{ old('fname', $securityOfficer->name) }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" name="email" placeholder="Email" class="form-control"
                                                value="{{ old('email', $securityOfficer->email) }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="gender"
                                                        value="Male"
                                                        {{ $securityOfficer->gender == 'Male' ? 'checked' : '' }}>
                                                    Male
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="gender"
                                                        value="Female"
                                                        {{ $securityOfficer->gender == 'Female' ? 'checked' : '' }}>
                                                    Female
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="mobilenumber" placeholder="Mobile Number"
                                                ...
                                                value="{{ old('mobilenumber', $securityOfficer->mobilenumber) }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="datetime-local" class="form-control" name="date_of_birth"
                                                value="{{ old('date_of_birth', $securityOfficer->date_of_birth) }}" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="cnic_number" placeholder="XXXXX-XXXXXXX-X"
                                                class="form-control"
                                                value="{{ old('cnic_number', $securityOfficer->cnic_number) }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="address1" placeholder="Address"
                                                class="form-control"
                                                value="{{ old('address1', $securityOfficer->address1) }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="address2" placeholder="Address"
                                                class="form-control"
                                                value="{{ old('address2', $securityOfficer->address2) }}" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="designation" placeholder="Designation"
                                                class="form-control"
                                                value="{{ old('designation', $securityOfficer->designation) }}" />
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control" name="department_id">
                                                @foreach (App\Models\Department::allDepartments() as $depart)
                                                    <option value="{{ $depart->id }}"
                                                        @if ($depart->id == $securityOfficer->depart->id) selected @endif>
                                                        {{ $depart->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="datetime-local" class="form-control" name="shift_start"
                                                value="{{ old('shift_start', $securityOfficer->shift_start) }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="datetime-local" class="form-control" name="shift_end"
                                                value="{{ old('shift_end', $securityOfficer->shift_end) }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="datetime-local" class="form-control" name="joing_date"
                                                value="{{ old('joing_date', $securityOfficer->joing_date) }}" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9">
                                            ...
                                            <img src="/storage/{{ $securityOfficer->image }}" width="50px"
                                                height="45px">
                                        </div>
                                    </div>
                                </div>
